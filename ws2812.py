...
class WS2812:
    ...
    def __init__(self, spi_bus, led_count=1, intensity=1):
        ...
        * intensity = light intensity (float up to 1)
        ...
        #self.spi = SPI(spi_bus, pyb.SPI.MASTER, baudrate=3200000, polarity=0, phase=1)
        #self.spi= SPI(1, 3200000, sck=Pin(14), mosi=Pin(13), miso=Pin(12))
        self.spi=spi_bus
        self.data=[(0,0,0)]
